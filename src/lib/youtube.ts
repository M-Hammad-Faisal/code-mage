...
const PLACEHOLDER_VIDEOS: YouTubeVideo[] = [
  {
    ...
    description: 'Learn the basics of Python variables, data types, and how to work with them effectively in your code.',
  ...
  },
  {
    ...
    description: 'Master Python list comprehensions with practical examples and best practices for cleaner code.',
    thumbnail: '/brand/Code Mage Banner.png',
  ...
  },
  {
    ...
    description: 'Step-by-step guide to creating a complete Python project from scratch with best practices.',
    thumbnail: '/brand/Code Mage Banner.png',
...
class YouTubeService {
  ...
  async getLatestVideos(maxResults: number = 6): Promise<YouTubeVideo[]> {
    ...
    if (!this.apiKey || !this.channelId) {
      console.warn('YouTube API key or channel ID not configured. Using placeholder videos.');
