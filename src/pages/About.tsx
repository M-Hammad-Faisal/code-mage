    ...
    <div className="min-h-screen bg-cloud-100 dark:bg-navy-900 py-16">
      <div className="container mx-auto px-4">
        ...
        <motion.div
          ...
          className="mb-20"
        >
          <h2 className="text-3xl font-bold text-gray-900 dark:text-cloud-100 mb-6">
            Our Mission
          </h2>
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              <p className="text-lg text-gray-700 dark:text-cloud-300 mb-6">
              ...
              <p className="text-lg text-gray-700 dark:text-cloud-300">
        ...
        <motion.div
          ...
          className="mb-20"
        >
          <h2 className="text-3xl font-bold text-gray-900 dark:text-cloud-100 text-center mb-12">
            What We Offer
          </h2>
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-white dark:bg-gray-800/80 rounded-xl shadow-lg dark:shadow-2xl p-6 border border-gray-200 dark:border-gray-600/50 text-center backdrop-blur-sm">
              ...
              <h3 className="text-xl font-bold text-gray-900 dark:text-cloud-100 mb-4">Full-Stack Development</h3>
              <p className="text-gray-600 dark:text-cloud-300">Building complete web applications from frontend to backend with modern technologies.</p>
            </div>
            ...
            <div className="bg-white dark:bg-gray-800/80 rounded-xl shadow-lg dark:shadow-2xl p-6 border border-gray-200 dark:border-gray-600/50 text-center backdrop-blur-sm">
              ...
              <h3 className="text-xl font-bold text-gray-900 dark:text-cloud-100 mb-4">UI/UX Design</h3>
              <p className="text-gray-600 dark:text-cloud-300">Creating beautiful and intuitive user interfaces with attention to user experience.</p>
            </div>
            ...
            <div className="bg-white dark:bg-gray-800/80 rounded-xl shadow-lg dark:shadow-2xl p-6 border border-gray-200 dark:border-gray-600/50 text-center backdrop-blur-sm">
              ...
              <h3 className="text-xl font-bold text-gray-900 dark:text-cloud-100 mb-4">Mobile Development</h3>
              <p className="text-gray-600 dark:text-cloud-300">Developing responsive mobile applications for iOS and Android platforms.</p>
            </div>
          </div>
        </motion.div>
        ...
        >
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-white dark:bg-gray-800/80 rounded-xl shadow-lg dark:shadow-2xl p-6 border border-gray-200 dark:border-gray-600/50 text-center backdrop-blur-sm">
              ...
              <h3 className="text-xl font-semibold text-gray-900 dark:text-cloud-100 mb-3">
                Quality First
              </h3>
              <p className="text-gray-600 dark:text-cloud-300">
        ...
        >
          ...
          <p className="text-lg text-gray-700 dark:text-cloud-300 max-w-2xl mx-auto mb-8">
