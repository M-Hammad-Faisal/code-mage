...
Or download individual spec files if you want to drop them into your own project — each is self-contained with inline page objects and test data, and real, passing code verified against the live site:
