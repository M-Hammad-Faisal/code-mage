...
2. **Writing Tests** — selectors and commands
3. **Assertions** — `expect-webdriverio` matchers
4. **Page Object Model** — structuring tests for maintainability
5. **Advanced Interactions** — browser control beyond the basics
6. **Flaky Tests** — retry strategies and diagnosis
7. **CI/CD** — running WDIO in GitHub Actions
