...
2. Cache dependencies so it does not re-download browsers every run
...
If you want to go further, check out [Playwright's trace viewer](https://playwright.dev/docs/trace-viewer) — it is essentially a DVR for your test run, and it integrates directly with the HTML report.
