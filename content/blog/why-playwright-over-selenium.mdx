...
excerpt: 'After years of writing Selenium tests, I switched to Playwright. Here''s what changed, what stayed the same, and whether the switch was worth it.'
featured: true
---
...
**Legacy browser support.** Still stuck testing an ancient internal app that only runs on a legacy IE-mode browser? Selenium is your only option there — but that's an increasingly rare corner of the industry, not a mainstream concern anymore.
