  ...
  return (
    <div className="min-h-screen py-12">
      ...
      <div className="container-max">
        ...
        <div
          className={
            showToc ? 'lg:grid lg:grid-cols-[1fr_220px] lg:gap-16 items-start' : 'max-w-2xl mx-auto'
          }
        >
          {/* Main content */}
          <div className={showToc ? 'min-w-0' : undefined}>
            {/* Header */}
          ...
          {/* TOC sidebar — only on large screens for long posts */}
          {showToc && (
